...
<html>
  ...
  <body>
    ...
    <section class="page-section container">
      ...
      <form class="was-validated" method="post" action="${root}/noticeupdate?id=${notice.id}&title=${notice.title}&content=${notice.content}">
      	<input type="hidden" name="id" value="${notice.id}" />
        <div class="mb-4" id="write-title-div">
          <label for="title" class="h5">제목</label>
          <input type="text" class="form-control" id="writeTitle" name="title" placeholder="${notice.title}" required />
